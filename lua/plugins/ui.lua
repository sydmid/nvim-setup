...
local symbol_icons = symbols.symbol_icons
local get_symbol_line = symbols.get_symbol_line
local sort_symbols_by_line = symbols.sort_symbols_by_line
local make_symbol_entry = symbols.make_symbol_entry
local jump_to_symbol = symbols.jump_to_symbol
local fetch_lsp_symbols = symbols.fetch_lsp_symbols
